...
uv run pytest -q         # 181 collected here; 142 pass, the rest skip without ES / the mcp extra
```
...
| Test suite | ✅ 191 tests with all extras; runs on 3.11–3.14, count drift-tested |
