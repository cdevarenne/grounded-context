...
uv run pytest -q         # 142 collected here; 105 pass, the rest skip without ES / the mcp extra
```
...
| Test suite | ✅ 152 tests with all extras; runs on 3.11–3.14, count drift-tested |
