...
uv run pytest -q         # 129 collected here; 94 pass, the rest skip without ES / the mcp extra
```
...
| Test suite | ✅ 140 tests with all extras; runs on 3.11–3.14, count drift-tested |
