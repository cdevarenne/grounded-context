...
uv run pytest -q         # 118 tests; optional-dependency tests skip when the extra is absent
```
...
| Test suite | ✅ 118 tests; runs on 3.11–3.14, optional-dependency tests skip |
